...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <form action="{{ route('forms.jateng-diy.create.step.two.post.1') }}" method="POST">
                @csrf
                            ...
                            <div class="mapform" >
                                ...
                                <script>
                                    ...
                                    function initMap() {
                                        ...
                                        const uluru = { lat: -7.1181799, lng: 110.0475669 };
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="{{ route('forms.jateng-diy.create.step.one') }}" class="btn btn-danger pull-right">Sebelumnya</a>
                            </div>
