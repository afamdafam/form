...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <form action="{{ route('forms.jabodetabek.create.step.two.post.1') }}" method="POST">
                @csrf
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="{{ route('forms.jabodetabek.create.step.one') }}" class="btn btn-danger pull-right">Sebelumnya</a>
                            </div>
