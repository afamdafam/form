...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <form action="{{ route('forms.solo.create.step.two.post.2') }}" method="POST">
                @csrf
                                ...
                                <script>
                                    ...
                                    function initMap() {
                                        map = new google.maps.Map(document.getElementById("map"), {
                                            center: { lat: -7.559166, lng: 110.7984339 },
                                            zoom: 13,
                                            scrollwheel: true,
                                        });

                                        const uluru = { lat: -7.559166, lng: 110.7984339 };
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="{{ route('forms.solo.create.step.two.1') }}" class="btn btn-danger pull-right">Sebelumnya</a>
                            </div>
