...
class JatengDIYFormController extends Controller
{
    public function index()
    {
        $forms = FormData::all();
        return view('forms.jateng-diy.index',compact('forms'));
    }
    ...
    public function createStepOne(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-one',compact('forms'));
    }
    ...
    public function postCreateStepOne(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.create.step.two.1');
    }
    ...
    public function createStepTwo1(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-two-1',compact('forms'));
    }
    ...
    public function postCreateStepTwo1(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.create.step.two.2');
    }
    ...
    public function createStepTwo2(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-two-2',compact('forms'));
    }
    ...
    public function postCreateStepTwo2(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.create.step.three');
    }
    ...
    public function createStepThree(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-three',compact('forms'));
    }
    ...
    public function postCreateStepThree(Request $request)
    {
        ...
        if ($forms->option && $forms->kendaraan_pribadi) {
            return redirect()->route('forms.jateng-diy.create.step.four.a');
        } else if (!$forms->option && $forms->kendaraan_pribadi){
            return redirect()->route('forms.jateng-diy.create.step.four.b1');
        } else {
            return redirect()->route('forms.jateng-diy.create.step.four.c');
        }
    }
    ...
    public function createStepFourA(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-four-A',compact('forms'));
    }
    ...
    public function postCreateStepFourA(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.success');
    ...
    public function createStepFourB1(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-four-B1',compact('forms'));
    }
    ...
    public function postCreateStepFourB1(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.create.step.four.b2');
    ...
    public function createStepFourB2(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-four-B2',compact('forms'));
    }
    ...
    public function createStepFourC(Request $request)
    {
        ...
        return view('forms.jateng-diy.create-step-four-C',compact('forms'));
    }
    ...
    public function formSuccess(Request $request){
        ...
        return view('forms.jateng-diy.forms-success');
    }
    public function postForm(Request $request)
    {
        ...
        return redirect()->route('forms.jateng-diy.index');
    }
}
