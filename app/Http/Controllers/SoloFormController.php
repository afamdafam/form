...
class SoloFormController extends Controller
{
    public function index()
    {
        $forms = FormData::all();
        return view('forms.solo.index',compact('forms'));
    }
    ...
    public function createStepOne(Request $request)
    {
        ...
        return view('forms.solo.create-step-one',compact('forms'));
    }
    ...
    public function postCreateStepOne(Request $request)
    {
        ...
        return redirect()->route('forms.solo.create.step.two.1');
    }
    ...
    public function createStepTwo1(Request $request)
    {
        ...
        return view('forms.solo.create-step-two-1',compact('forms'));
    }
    ...
    public function postCreateStepTwo1(Request $request)
    {
        ...
        return redirect()->route('forms.solo.create.step.two.2');
    }
    ...
    public function createStepTwo2(Request $request)
    {
        ...
        return view('forms.solo.create-step-two-2',compact('forms'));
    }
    ...
    public function postCreateStepTwo2(Request $request)
    {
        ...
        return redirect()->route('forms.solo.create.step.three');
    }
    ...
    public function createStepThree(Request $request)
    {
        ...
        return view('forms.solo.create-step-three',compact('forms'));
    }
    ...
    public function postCreateStepThree(Request $request)
    {
        ...
        if ($forms->option && $forms->kendaraan_pribadi) {
            return redirect()->route('forms.solo.create.step.four.a');
        } else if (!$forms->option && $forms->kendaraan_pribadi){
            return redirect()->route('forms.solo.create.step.four.b1');
        } else {
            return redirect()->route('forms.solo.create.step.four.c');
        }
    }
    ...
    public function createStepFourA(Request $request)
    {
        ...
        return view('forms.solo.create-step-four-A',compact('forms'));
    }
    ...
    public function postCreateStepFourA(Request $request)
    {
        ...
        return redirect()->route('forms.solo.success');
    ...
    public function createStepFourB1(Request $request)
    {
        ...
        return view('forms.solo.create-step-four-B1',compact('forms'));
    }
    ...
    public function postCreateStepFourB1(Request $request)
    {
        $validatedData = $request->validate([
            'maksud_perjalanan' => 'required',
            'frekuensi_perjalanan' => 'required|numeric',
            'kendaraan_berangkat_kereta_api' => 'required_without_all:kendaraan_berangkat_bus_akap,kendaraan_berangkat_bus_akdp,kendaraan_berangkat_brt,kendaraan_berangkat_angkutan_kota,kendaraan_berangkat_ojol',
            'kendaraan_berangkat_bus_akap' => 'required_without_all:kendaraan_berangkat_kereta_api,kendaraan_berangkat_bus_akdp,kendaraan_berangkat_brt,kendaraan_berangkat_angkutan_kota,kendaraan_berangkat_ojol',
            'kendaraan_berangkat_bus_akdp' => 'required_without_all:kendaraan_berangkat_kereta_api,kendaraan_berangkat_bus_akap,kendaraan_berangkat_brt,kendaraan_berangkat_angkutan_kota,kendaraan_berangkat_ojol',
            'kendaraan_berangkat_brt' => 'required_without_all:kendaraan_berangkat_kereta_api,kendaraan_berangkat_bus_akap,kendaraan_berangkat_bus_akdp,kendaraan_berangkat_angkutan_kota,kendaraan_berangkat_ojol',
            'kendaraan_berangkat_angkutan_kota' => 'required_without_all:kendaraan_berangkat_kereta_api,kendaraan_berangkat_bus_akap,kendaraan_berangkat_bus_akdp,kendaraan_berangkat_brt,kendaraan_berangkat_ojol',
            'kendaraan_berangkat_ojol' => 'required_without_all:kendaraan_berangkat_kereta_api,kendaraan_berangkat_bus_akap,kendaraan_berangkat_bus_akdp,kendaraan_berangkat_brt,kendaraan_berangkat_angkutan_kota',
            'kendaraan_pulang_kereta_api' => 'required_without_all:kendaraan_pulang_bus_akap,kendaraan_pulang_bus_akdp,kendaraan_pulang_brt,kendaraan_pulang_angkutan_kota,kendaraan_pulang_ojol',
            'kendaraan_pulang_bus_akap' => 'required_without_all:kendaraan_pulang_kereta_api,kendaraan_pulang_bus_akdp,kendaraan_pulang_brt,kendaraan_pulang_angkutan_kota,kendaraan_pulang_ojol',
            'kendaraan_pulang_bus_akdp' => 'required_without_all:kendaraan_pulang_kereta_api,kendaraan_pulang_bus_akap,kendaraan_pulang_brt,kendaraan_pulang_angkutan_kota,kendaraan_pulang_ojol',
            'kendaraan_pulang_brt' => 'required_without_all:kendaraan_pulang_kereta_api,kendaraan_pulang_bus_akap,kendaraan_pulang_bus_akdp,kendaraan_pulang_angkutan_kota,kendaraan_pulang_ojol',
            'kendaraan_pulang_angkutan_kota' => 'required_without_all:kendaraan_pulang_kereta_api,kendaraan_pulang_bus_akap,kendaraan_pulang_bus_akdp,kendaraan_pulang_brt,kendaraan_pulang_ojol',
            'kendaraan_pulang_ojol' => 'required_without_all:kendaraan_pulang_kereta_api,kendaraan_pulang_bus_akap,kendaraan_pulang_bus_akdp,kendaraan_pulang_brt,kendaraan_pulang_angkutan_kota',
        ...
        return redirect()->route('forms.solo.create.step.four.b2');
    ...
    public function createStepFourB2(Request $request)
    {
        ...
        return view('forms.solo.create-step-four-B2',compact('forms'));
    }
    ...
    public function createStepFourC(Request $request)
    {
        ...
        return view('forms.solo.create-step-four-C',compact('forms'));
    }
    ...
    public function formSuccess(Request $request){
        ...
        return view('forms.solo.forms-success');
    }
    public function postForm(Request $request)
    {
        ...
        return redirect()->route('forms.solo.index');
    }
}
