...
{
    protected $fillable = [
        'profesi', 'profesi_lainnya', 'umur', 'ukuran_keluarga', 'kedudukan_keluarga', 'maksud_perjalanan',
        'tulis_maksud', 'berangkat_pulang', 'frekuensi_perjalanan', 'kendaraan_pribadi', 'alamat_kota',
        'alamat_latitude', 'alamat_longitude', 'tujuan_kota', 'tujuan_latitude', 'tujuan_longitude',
